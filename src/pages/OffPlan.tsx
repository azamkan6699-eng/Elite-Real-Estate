  ...
  return (
    <>
      <Helmet>
        ...
        {/* <!-- Open Graph / Facebook --> */}
        <meta property="og:title" content="Off-Plan Properties | Sky Elite Real Estate" />
        ...
        <meta name="twitter:image" content="https://elite-real-estate-five.vercel.app/Thumbnail.png?v=2" />
